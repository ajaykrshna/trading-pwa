        ...
        <div className="buy">
            <div className="buy--head--details">
                ...
                <div className="buy--input">
                    <div className="buy--input--type">Sell in INR</div>
                    <input
                        type="number"
                        placeholder="0"
                        id="price"
            ...
            <div className="buy--button">
                <button onClick={() => price ? price !== 0 ? navigate("/sell/preview") : setWarning(warningMessage) : setWarning(warningMessage)}>Continue</button>
            </div>
        </div>
    )
}
